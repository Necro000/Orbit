...
import { useRecent } from '@/lib/search';
...
export default function RecentPage() {
  ...
  return (
    <AppShell
      breadcrumbPath={[{ id: 'recent', name: 'Recent' }]}
      toolbarProps={{
        view,
          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
              <div className="empty-state">
                <p className="empty-state-subtitle">Loading recent items...</p>
              </div>
            ) : items.length === 0 ? (
              <div className="empty-state">
                ...
                <p className="empty-state-body">
                  Items you have recently opened, uploaded, or shared will appear here.
                </p>
              </div>
            ) : view === 'grid' ? (
              <FileGrid
