...
export default function SharedPage() {
  ...
  return (
    <AppShell
      breadcrumbPath={[{ id: 'shared', name: 'Shared with me' }]}
      toolbarProps={{
        view,
          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
              <div className="empty-state">
                <p className="empty-state-subtitle">Loading shared items...</p>
              </div>
            ) : items.length === 0 ? (
              <div className="empty-state">
                ...
                <p className="empty-state-body">
                  When other users share folders or files with you, they will appear here.
                </p>
              </div>
            ) : view === 'grid' ? (
              <FileGrid
